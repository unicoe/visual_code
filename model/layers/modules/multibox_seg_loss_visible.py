...
class MultiBoxLoss(nn.Module):
    ...
    def forward(self, predictions, bbox_targets, seg_targets, seg_visible_targets):
        """Multibox Loss
        Args:
        ...
        """
        loc_data, conf_data, priors, fcn_output, fcn_visible_output = predictions
        ...
        loss_l /= N
        loss_c /= N
        return loss_l, loss_c, loss_seg, loss_seg_visible
