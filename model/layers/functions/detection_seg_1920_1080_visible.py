...
class DetectSeg(Function):
    ...
    def __init__(self, num_classes, size, bkg_label, top_k, conf_thresh, nms_thresh):
        ...
        cfg = v["1920_1080_base512"]
        self.variance = cfg['variance']
        self.output = torch.zeros(1, self.num_classes, self.top_k, 5)

    def forward(self, loc_data, conf_data, prior_data, fcn_output, fcn_output_vis):
        """
        Args:
        ...
        # 最简单的输出
        return self.output, fcn_output, fcn_output_vis
