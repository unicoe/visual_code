...
class log(object):
    # root logger setting
    mkdir("/home/user/Disk1.8T/unicoe/pytorch-ssd-2/experments/12_10/logs/")
    save_path = "/home/user/Disk1.8T/unicoe/pytorch-ssd-2/experments/12_10/logs/" + time.strftime("%m_%d_%H_%M") + '.log'
    l = logging.getLogger()
